...
function About() {  
    return (
        ...
        <p>I specialize in building responsive websites, interactive browser games, and professional landing pages that deliver results.</p>
        <Link to="/projects" className={styled.btn}>View My Work</Link>
    </div>
        <h2>About Me</h2>
        <div className={styled.hero}>
            <p>I am a passionate web developer and designer skilled in HTML, CSS, JavaScript, React, Python and Tailwind CSS, with experience in front-end web development, I ensure designing, and structuring modern, responsive web pages.
